...
public class LogIn extends JFrame{
    ...
    public void displayError(String str)
    {
         ...
         */
        //Creates an anonymous class implementing action listen
        new Timer(2000,
                e -> {    //Override the actionPerformed method from super class
    ...
    */
        ...
        //LogIn Button;
        JButton logInBtn = new JButton("Log In");   //initializing LogIn Button
        ...
        user = new JRadioButton(
                "Customer", //Creates a new radio button With text Consumer
                true    //checkbox will be selected by default
        );
        staff = new JRadioButton("Admin", false);   //Same as above but check box will not be selected
        ...
        //With the help of button group now only one radio button can be selected at a time
        ...
        this.add(developer);
        this.setTitle("Billing System Log In");    //Set title of window
    ...
    public void displayUserGUI() {
        logInLabel.setText("Customer ID: ");
